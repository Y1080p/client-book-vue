          ...
          <div class="card-body">
            ...
            <div class="row mb-4">
              <div class="col-md-6">
                ...
                <p v-if="order.pay_time"><strong>支付时间：</strong>{{ formatDate(order.pay_time) }}</p>
                <p v-if="order.complete_time"><strong>完成时间：</strong>{{ formatDate(order.complete_time) }}</p>
              </div>
              <div class="col-md-6">
            ...
            <div class="mb-4">
              ...
              <div class="border rounded p-3 bg-light">
                ...
                <template v-else-if="order.address_info">
                  <p class="mb-0 text-muted"><i class="bi bi-info-circle me-2"></i>该订单使用已删除的收货地址</p>
                </template>
                <template v-else>
